        ...
        "groups": (
            {
                ...
                "items": (
                    ...
                    "Added a live and retained PCAP header viewer showing bounded source/destination MAC and IP addresses, ports, protocols, VLANs, timestamps, and lengths without exposing payload bodies.",
                    "Added explicit Save to datastore controls plus basic inspection of .pcap, .pcapng, and .cap files already retained in Local Datastore.",

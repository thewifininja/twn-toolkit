        ...
        "groups": (
            {
                ...
                "items": (
                    ...
                    "Closes a half-closed relay after five idle seconds and restores default termination signals in per-connection children, while shared SSH cleanup explicitly closes sockets that Paramiko marks inactive after a failed banner.",

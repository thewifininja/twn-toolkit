    ...
    registry.map_endpoints(
        {
            ...
            "configuration_export_job": "admin.updates",
            "configuration_export_status": "admin.updates",
            "configuration_export_cancel": "admin.updates",
            "configuration_export_download": "admin.updates",

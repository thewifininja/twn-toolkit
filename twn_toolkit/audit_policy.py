...
AUDIT_ANNOTATED_ENDPOINTS = frozenset(
    {
        ...
        "fortigate_dhcp_cancel", "fortigate_loop_cancel",
        "switch_order_cancel",
        "rename_job_cancel",
        "fac_cleanup_cancel",
        "case_export_cancel",
        ...
        "fabric_discovery_cancel", "appliance_task_cancel", "fortigate_connection_cancel", "fortiauthenticator_connection_cancel",
        "tools.radius_test",

        ...
        try:
            after = operational_store.save({
                ...
                **{key: request.form.get(key, value) for key, value in before.items() if key.startswith("diagnostic_")},
                ...
                "distributed_listener_connections": request.form.get("distributed_listener_connections", before["distributed_listener_connections"]),
                "distributed_control_reserve": request.form.get("distributed_control_reserve", before["distributed_control_reserve"]),
                "distributed_agent_long_polls": request.form.get("distributed_agent_long_polls", before["distributed_agent_long_polls"]),
